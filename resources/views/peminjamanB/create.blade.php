          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 mb-5">
              <div class="card-container mt-4 p-3 border rounded">
                <div class="float-end">
                  <a href="{{ route('peminjamanB.index') }}" class="btn btn-sm btn-outline-primary">Kembali</a>
                </div>
                <h5 class="mb-3 text-dark">Form Meminjam Barang </h5>

                <form action="{{ route('peminjamanB.store') }}" method="POST" class="p-4 shadow-lg bg-white rounded">
                    @csrf
                    <label for="nama_peminjam" style="display: block; margin-bottom: 5px; font-weight: bold;">Nama Peminjam</label>
                    ...
                    <label for="tanggal_peminjaman" style="display: block; margin-bottom: 5px; font-weight: bold;">Tanggal Meminjam</label>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <input type="text" id="kode_peminjaman" name="kode_peminjaman" class="form-control" value="{{ $kodePeminjaman }}" readonly>
                    </div> --}}
