          ...
          <div class="row justify-content-center">
            <div class="col-lg-10 mb-5">
              <div class="card-container mt-4 p-3 border rounded">
                ...
                <h5 class="mb-3 text-dark">Form Tambah Barang</h5>

                <form action="{{ route('barang.store') }}" method="POST" style="max-width: 500px; margin: auto; padding: 20px; border-radius: 8px; background: #f9f9f9; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    @csrf
                    ...
                    <label for="stok" style="display: block; margin-bottom: 5px; font-weight: bold;">Stok</label>
                    <input type="number" id="stok" name="stok" required
                           style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 15px;">
                    <label for="keterangan_barang" style="display: block; margin-bottom: 5px; font-weight: bold;">Keterangan Barang</label>
                    <input type="text" id="keterangan_barang" name="keterangan_barang" required
                           style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px; margin-bottom: 15px;">
